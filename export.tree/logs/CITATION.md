...
: A total of 5 fieldmaps were found available within the input
...
5 T2w images (after INU-correction) using
`mri_robust_template` [FreeSurfer 7.3.2, @fs_template].
...
: For each of the 50 BOLD runs found per subject (across all
